  ...
  <div class="seller" v-el:seller>
    <div class="seller-content">
      ...
      <div class="bulletin">
        ...
        <div class="content-wrapper border-wrapper">
          <p class="content">
            {{seller.bulletin}}
          </p>
        </div>
        <ul v-if="seller.supports" class="supports">
            <li v-for="item in seller.supports" :key="item" class="support-item border-1px">
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper" v-el:pics-wrapper>
          <ul class="pic-list" v-el:pics-list>
